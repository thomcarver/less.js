...
var render = function (toCssOptions, input, options, callback) {
    options = options || {};
    ...
    if (callback) {
        parser.parse(input, function (e, root) {
            callback(e, root.toCSS(toCssOptions));
        });
    } else {
        ...
        process.nextTick(function () {
            parser.parse(input, function (e, root) {
                ...
                else   { ee.emit('success', root.toCSS(toCssOptions)) }
            });
        });
        return ee;
    }
...
var less = {
    ...
    render: render.bind(this, undefined),
    renderMinified: render.bind(this, { compress: true }),
